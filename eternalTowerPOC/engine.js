...
function createCircle(x, y, radius, color, id) {
  ...
  circle.setAttribute(
    "style",
    `left:${x}px;top:${y}px;width:${radius};height:${radius};background-color:${color};position:absolute;border-radius:50%`
  );
  return circle;
}
...
function createSquare(x, y, width, height, color, id) {
  ...
  square.setAttribute(
    "style",
    `left:${x}px;top:${y}px;width:${width};height:${height};background-color:${color};position:absolute;`
  );
  if (id != "" || id != null) {
    square.setAttribute("id", id);
  }
...
function createTriangle(x, y, leftw, rightw, height, color, id) {
  ...
  triangle.setAttribute(
    "style",
    `left:${x}px;top:${y}px;width:0px;height:0px;position:absolute;border-left: ${leftw} solid transparent;border-right:${rightw} solid transparent;border-bottom:${height} solid ${color}`
  );
  if (id != "" || id != null) {
